...
const cacheName = 'fixit6JohnRiley_appStudio-2020-09-20 19:32:22.481238'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit6JohnRiley_appStudio'.length) === 'fixit6JohnRiley_appStudio') {
